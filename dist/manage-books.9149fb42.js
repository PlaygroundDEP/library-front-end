...
})({"auuCE":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "17ac86049149fb42";
...
},{}],"4Cejl":[function(require,module,exports) {
...
});*/ const BOOKS_API = `${"http://localhost:8080/library"}/v2/books`;
loadBooks();
txtSearch.addEventListener('input', ()=>loadBooks(txtSearch.value)
);
function loadBooks(query = '', page = 1) {
    httpRequest('GET', `${BOOKS_API}?q=${query}&page=${page}&size-${pageSize}`).then((data)=>{
        /*Let's clear the table*/ tblBooks.querySelectorAll("tr").forEach((row)=>row.remove()
        );
...
},{}]},["auuCE","4Cejl"], "4Cejl", "parcelRequire56ab")

//# sourceMappingURL=manage-books.9149fb42.js.map
