!function(e, t) {
    ...
    "use strict";
    const H = "SweetAlert2:", q = (e)=>e.charAt(0).toUpperCase() + e.slice(1)
    ...
    , u1 = (e)=>U(e) ? e.toPromise() : Promise.resolve(e)
    ...
    ], K = (e)=>Object.prototype.hasOwnProperty.call(r1, e)
    , Y = (e)=>-1 !== W.indexOf(e)
    , Z = (e)=>z[e]
    , J = (e)=>{
        !e.backdrop && e.allowOutsideClick && a1('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`');
        for(const n in e)t = n, K(t) || a1('Unknown parameter "'.concat(t, '"')), e.toast && (t = n, _.includes(t) && a1('The parameter "'.concat(t, '" is incompatible with toasts'))), t = n, Z(t) && N(t, Z(t));
        var t;
    };
    var e1 = (e)=>{
        const t = {};
    ...
    , $ = ()=>n1(p["html-container"])
    , Q = ()=>n1(p.image)
    , G = ()=>n1(p["progress-steps"])
    , ee = ()=>n1(p["validation-message"])
    , h = ()=>t1(".".concat(p.actions, " .").concat(p.confirm))
    , f = ()=>t1(".".concat(p.actions, " .").concat(p.deny))
    ;
    const d1 = ()=>t1(".".concat(p.loader))
    , b = ()=>t1(".".concat(p.actions, " .").concat(p.cancel))
    , y = ()=>n1(p.actions)
    , te = ()=>n1(p.footer)
    , ne = ()=>n1(p["timer-progress-bar"])
    , oe = ()=>n1(p.close)
    , ie = ()=>{
    ...
    const c1 = {
        ...
        for(let e6 = 0; e6 < n.length; e6++)if (w(n[e6], t)) return n[e6];
    }, pe = (e, t, n)=>{
    ...
    , xe = (e)=>{
        ...
        var n2, o2, i, a, r, s = y(), c = d1();
        (t4.showConfirmButton || t4.showDenyButton || t4.showCancelButton ? B : x)(s), C(s, t4, "actions"), n2 = c, o2 = t4, i = h(), a = f(), r = b(), Me(i, "confirm", o2), Me(a, "deny", o2), Me(r, "cancel", o2), function(e, t, n, o) {
            if (!o.buttonsStyling) return k([
                e,
                t,
                n
            ], p.styled);
            A([
                ...
                t,
                n
            ], p.styled), o.confirmButtonColor && (e.style.backgroundColor = o.confirmButtonColor, A(e, p["default-outline"]));
        ...
        }(i, a, r, o2), o2.reverseButtons && (o2.toast ? (s.insertBefore(r, i), s.insertBefore(a, i)) : (s.insertBefore(r, n2), s.insertBefore(a, n2), s.insertBefore(i, n2))), v(c, t4.loaderHtml), C(c, t4, "loader");
    };
    function Me(e, t, n) {
    ...
    const Ie = (e, t)=>{
        ...
        i && (o = i, "string" == typeof (n = t.backdrop) ? o.style.background = n : n || A([
            document.documentElement,
            document.body
        ], p["no-backdrop"]), o = i, (n = t.position) in p ? A(o, p[n]) : (a1('The "position" parameter is not valid, defaulting to "center"'), A(o, p.center)), n = i, (o = t.grow) && "string" == typeof o && (o = "grow-".concat(o)) in p && A(n, p[o]), C(i, t, "container"));
    };
    var L = {
    ...
    const De = [
        ...
        const s = g();
        var t5, e8 = L.innerParams.get(e8);
        ...
        De.forEach((e)=>{
            ...
            if (!O[e.input]) return l1('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(e.input, '"'));
            const t = Re(e.input), n = O[e.input](t, e);
            B(n), setTimeout(()=>{
                ue(n);
            });
        })(r), e8 = r, t5 = Re(e8.input), e8.customClass && A(t5, e8.customClass.input));
    }, qe = (t)=>{
        ...
        [
            "string",
            "number"
        ].includes(typeof t.inputValue) ? e.value = "".concat(t.inputValue) : F(t.inputValue) || a1('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"'));
    }, Fe = (O.text = O.email = O.password = O.number = O.tel = O.url = (e, t)=>(Ue(e, t), Ne(e, e, t), Ve(e, t), e.type = t.input, e)
    ...
    , O.checkbox = (e, t)=>{
        ...
        var e = L.innerParams.get(e), n = s1();
        return e && t.icon === e.icon ? (Xe(n, t), void Ke(n, t)) : t.icon || t.iconHtml ? t.icon && -1 === Object.keys(o1).indexOf(t.icon) ? (l1('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')), x(n)) : (B(n), Xe(n, t), Ke(n, t), void A(n, t.showClass.icon)) : x(n);
    }, Ke = (e, t)=>{
        for(const n in o1)t.icon !== n && k(e, o1[n]);
        A(e, o1[t.icon]), $e(e, t), Ye(), C(e, t, "icon");
    }, Ye = ()=>{
        const e = g();
    ...
    , Ge = (e, t)=>{
        ...
        B(i), i.textContent = "", o.currentProgressStep >= o.progressSteps.length && a1("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), o.progressSteps.forEach((e12, t6)=>{
            n = document.createElement("li"), A(n, p["progress-step"]), v(n, e12);
            var n, e12 = n;
            i.appendChild(e12), t6 === o.currentProgressStep && A(e12, p["active-progress-step"]), t6 !== o.progressSteps.length - 1 && (n = ((e)=>{
        ...
        var n = m();
        const o = g();
        t.toast ? (pe(n, "width", t.width), o.style.width = "100%", o.insertBefore(d1(), s1())) : pe(o, "width", t.width), pe(o, "padding", t.padding), t.color && (o.style.color = t.color), t.background && (o.style.background = t.background), x(ee());
        n = o;
        (n.className = "".concat(p.popup, " ").concat(E(n) ? t.showClass.popup : ""), t.toast) ? (A([
            document.documentElement,
            document.body
        ], p["toast-shown"]), A(n, p.toast)) : A(n, p.modal);
    ...
    function ht(e19) {
        (t = e19).inputValidator || Object.keys(gt).forEach((e)=>{
        ...
        var t, n = e19, e19 = ke();
        if (ye()) l1("SweetAlert2 requires document to initialize");
        else {
            const o = document.createElement("div"), i = (o.className = p.container, e19 && A(o, p["no-transition"]), v(o, Ae), Be(n.target));
    ...
    const bt = ()=>{
        null === c1.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (c1.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")), document.body.style.paddingRight = "".concat(c1.previousBodyPadding + (()=>{
        ...
        null !== c1.previousBodyPadding && (document.body.style.paddingRight = "".concat(c1.previousBodyPadding, "px"), c1.previousBodyPadding = null);
    }, vt = ()=>{
        ...
        A(e, n.showClass.backdrop), t.style.setProperty("opacity", "0", "important"), B(t, "grid"), setTimeout(()=>{
            ...
            document.documentElement,
            document.body
        ], p.shown), n.heightAuto && n.backdrop && !n.toast && A([
            document.documentElement,
            document.body
        ], p["height-auto"]);
    }, I = (e)=>{
        ...
        if (re()) x(s1());
            ...
            a.parentNode.insertBefore(a, e), A([
                o,
                i
            ], p.loading);
        }
        ...
        ;
        U(n.inputOptions) || F(n.inputOptions) ? (I(h()), u1(n.inputOptions).then((e)=>{
            t.hideLoading(), i(e);
        ...
        const o = t.getInput();
        x(o), u1(n.inputValue).then((e)=>{
            o.value = "number" === n.input ? parseFloat(e) || 0 : "".concat(e), B(o), o.focus(), t.hideLoading();
        }).catch((e)=>{
            l1("Error in inputValue promise: ".concat(e)), o.value = "", B(o), o.focus(), t.hideLoading();
        });
    }, St = {
        select: (e22, t8, i)=>{
            const a = P(e22, p.select), r = (e, t, n)=>{
        ...
        radio: (e24, t9, a)=>{
            const r = P(e24, p.radio), n3 = (t9.forEach((e)=>{
                var t = e[0], e = e[1];
                const n = document.createElement("input"), o = document.createElement("label"), i = (n.type = "radio", n.name = p.radio, n.value = t, Ot(t, a.inputValue) && (n.checked = !0), document.createElement("span"));
    ...
    function jt() {
        ...
        if (t) {
            ...
            x(n.loader), re() ? t.icon && B(s1()) : (t = n, (e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"))).length ? B(e[0], "inline-block") : he() && x(t.actions)), k([
                n.popup,
                n.actions
    ...
    const Dt = (e)=>{
        ...
        if (o && !n.isComposing && 229 !== n.keyCode) {
            if (o.stopKeydownPropagation && n.stopPropagation(), "Enter" === n.key) s = n, i = o, R(i.allowEnterKey) && s.target && e.getInput() && s.target.outerHTML === e.getInput().outerHTML && ([
                "textarea",
                "file"
            ].includes(i.input) || (It(), s.preventDefault()));
            else if ("Tab" === n.key) {
                e = n;
                var i = o;
                var a = e.target, r = ie();
    ...
    function Rt(e, t, n, o) {
        re() ? zt(e, o) : (Ce(n).then(()=>zt(e, o)
        ), Dt(T)), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (t.setAttribute("style", "display:none !important"), t.removeAttribute("class"), t.innerHTML = "") : t.remove(), ae() && (yt(), Ct(), at()), k([
            document.documentElement,
            document.body
        ], [
            p.shown,
    ...
    function Ut(e27) {
        ...
        const t10 = Mt.swalPromiseResolve.get(this);
        var n5 = ((e)=>{
            const t = g();
            if (!t) return false;
        ...
        this.isAwaitingPromise() ? e27.isDismissed || (Ft(this), t10(e27)) : n5 && t10(e27);
    }
    const Ft = (e)=>{
        e.isAwaitingPromise() && (L.awaitingPromise.delete(e), L.innerParams.get(e) || e._destroy());
    }, Wt = (e28, t, n)=>{
        var o, i, a, r = m(), s = Oe && be(t);
        "function" == typeof n.willClose && n.willClose(t), s ? (s = e28, o = t, t = r, i = n.returnFocus, a = n.didClose, T.swalCloseEventFinishedCallback = Rt.bind(null, s, t, i, a), o.addEventListener(Oe, function(e) {
            e.target === o && (T.swalCloseEventFinishedCallback(), delete T.swalCloseEventFinishedCallback);
        })) : Rt(e28, r, n.returnFocus, n.didClose);
    }, zt = (e, t)=>{
        setTimeout(()=>{
    ...
    e1 = Object.freeze({
        ...
        update: function(e31) {
            var t11 = g(), n6 = L.innerParams.get(this);
            if (!t11 || w(t11, n6.hideClass.popup)) return a1("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
            t11 = ((t)=>{
                const n = {};
            ...
            })(e31), n6 = Object.assign({}, n6, t11), ot(this, n6), L.innerParams.set(this, n6), Object.defineProperties(this, {
                params: {
    ...
    const Jt = (e32, t12)=>{
        ...
        if (n7.inputValidator) {
            ...
            var a = o3;
            var r = t12;
            const s = L.innerParams.get(i), c = (i.disableInput(), Promise.resolve().then(()=>u1(s.inputValidator(a, s.validationMessage))
            ));
            c.then((e)=>{
                i.enableButtons(), i.enableInput(), e ? i.showValidationMessage(e) : ("deny" === r ? Xt : Gt)(i, a);
            });
        } else e32.getInput().checkValidity() ? ("deny" === t12 ? Xt : Gt)(e32, o3) : (e32.enableButtons(), e32.showValidationMessage(n7.validationMessage));
    }, Xt = (t, n)=>{
        const e33 = L.innerParams.get(t || void 0);
        if (e33.showLoaderOnDeny && I(f()), e33.preDeny) {
        ...
        const e34 = L.innerParams.get(t || void 0);
        if (e34.showLoaderOnConfirm && I(), e34.preConfirm) {
    ...
    var mn = Object.freeze({
        ...
        argsToParams: (n)=>{
            const o = {};
            return "object" != typeof n[0] || sn(n[0]) ? [
                "title",
                "html",
                "icon"
            ].forEach((e, t)=>{
                t = n[t];
                "string" == typeof t || sn(t) ? o[e] = t : void 0 !== t && l1("Unexpected type of ".concat(e, '! Expected "string" or "Element", got ').concat(typeof t));
    ...
    class D {
        ...
        _main(e) {
            var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, e = (J(Object.assign({}, t, e)), T.currentInstance && (T.currentInstance._destroy(), ae() && at()), T.currentInstance = this, fn(e, t)), t = (ht(e), Object.freeze(e), T.timeout && (T.timeout.stop(), delete T.timeout), clearTimeout(T.restoreFocusTimeout), bn(this));
    ...
    const hn = (l, u, d)=>new Promise((e37, t13)=>{
            ...
            var o, i, a;
            Mt.swalPromiseResolve.set(l, e37), Mt.swalPromiseReject.set(l, t13), u.confirmButton.onclick = ()=>{
            ...
            , e37 = l, t13 = u, a = n, L.innerParams.get(e37).toast ? en(e37, t13, a) : (nn(t13), on(t13), an(e37, t13, a)), o = l, e37 = T, t13 = d, i = n, Dt(e37), t13.toast || (e37.keydownHandler = (e)=>Nt(o, e, i)
            , e37.keydownTarget = t13.keydownListenerCapture ? window : g(), e37.keydownListenerCapture = t13.keydownListenerCapture, e37.keydownTarget.addEventListener("keydown", e37.keydownHandler, {
                capture: e37.keydownListenerCapture
            }), e37.keydownHandlerAdded = !0), a = l, "select" === (t13 = d).input || "radio" === t13.input ? Et(a, t13) : [
                "text",
                "email",
                "number",
                "tel",
                "textarea"
            ].includes(t13.input) && (U(t13.inputValue) || F(t13.inputValue)) && (I(h()), Tt(a, t13));
            {
                var r = d;
                const s = m(), c = g();
                "function" == typeof r.willOpen && r.willOpen(c), e37 = window.getComputedStyle(document.body).overflowY, xt(s, c, r), setTimeout(()=>{
                    Pt(s, c);
                }, At), ae() && (Bt(s, r.scrollbarPadding, e37), it()), re() || T.previousActiveElement || (T.previousActiveElement = document.activeElement), "function" == typeof r.didOpen && setTimeout(()=>r.didOpen(c)
                ), k(s, p["no-transition"]);
            }
    ...
    }, An = (Object.assign(D.prototype, e1), Object.assign(D, mn), Object.keys(e1).forEach((e)=>{
        D[e] = function() {
...
//# sourceMappingURL=manage-books.45c7245c.js.map
